...
-libraryjars libs/walle.jar
-libraryjars libs/walle-reader-1.1.6.jar
-libraryjars libs/miit_mdid_1.0.10.jar
...
-keep class com.jmhy.sdk.view.FloatView {
    <fields>;
    <methods>;
}
...
-keep class com.jmhy.sdk.activity.JmPaywebActivity {
    <fields>;
    <methods>;
}

-keep class com.jmhy.sdk.activity.JmUserinfoActivity {
    <fields>;
    <methods>;
}

-keep class com.jmhy.sdk.utils.JsInterface {
    <fields>;
    <methods>;
}
-keep class com.jmhy.sdk.utils.JspayInterface {
    <fields>;
    <methods>;
}

-keep class com.jmhy.sdk.utils.MiitHelper {
    <fields>;
    <methods>;
}
-keepclassmembers class * extends android.os.Parcelable {
...
-keep class com.jmhy.sdk.model.LoginMessageinfo {
    <fields>;
    <methods>;
}

-keep class com.jmhy.sdk.model.PaymentInfo {
    <fields>;
    <methods>;
}

-keep class com.jmhy.sdk.common.JMSDK {
    <fields>;
    <methods>;
}
...
-keep com.game.jm.qyz.R$*
-dontwarn com.game.jm.qyz.R$*
-dontwarn com.umeng.**
-dontwarn com.taobao.**
