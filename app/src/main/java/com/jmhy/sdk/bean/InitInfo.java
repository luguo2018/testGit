...
public class InitInfo {
    int is_sdk_float_on;
    int is_user_float_on;
    int is_logout_float_on;
    int is_reg_login_on;
    int is_visitor_on;
    int is_visitor_on_phone;
    ...
    int skin;
    String h5_game_url;
    List<String> code_area_list;
    int reg_flow_type;
    int expired;
    int online_report_interval;
    String show_url_after_init;
    String access_token;
    String user_agreement_url;
    String forget_password_url;
    String add_global_script_url;
    int u_p_init;
    String customer_service_url;
    String sk;
    ...
    public JSONObject getMoblie_direct_login() {
        return moblie_direct_login;
    }

    public void setMoblie_direct_login(JSONObject moblie_direct_login) {
    ...
    public String toString() {
        return "InitInfo{" +
                "is_sdk_float_on=" + is_sdk_float_on +
                ", is_user_float_on=" + is_user_float_on +
                ", is_logout_float_on=" + is_logout_float_on +
                ", is_reg_login_on=" + is_reg_login_on +
                ", is_visitor_on=" + is_visitor_on +
                ", is_visitor_on_phone=" + is_visitor_on_phone +
                ", is_auto_login_on=" + is_auto_login_on +
                ", is_log_on=" + is_log_on +
                ", is_shm=" + is_shm +
                ...
                ", reg_flow_type=" + reg_flow_type +
                ", expired=" + expired +
                ", online_report_interval=" + online_report_interval +
                ", show_url_after_init='" + show_url_after_init + '\'' +
                ", access_token='" + access_token + '\'' +
                ", user_agreement_url='" + user_agreement_url + '\'' +
                ", forget_password_url='" + forget_password_url + '\'' +
                ", add_global_script_url='" + add_global_script_url + '\'' +
                ", u_p_init=" + u_p_init +
