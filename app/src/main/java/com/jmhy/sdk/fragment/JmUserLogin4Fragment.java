...
public class JmUserLogin4Fragment extends JmBaseFragment implements
		OnClickListener {
	// 吉米
	private View mIvregister;
		...
		switch (AppConfig.skin){
			case 5:
				view = inflater.inflate(AppConfig.resourceId(getActivity(),
						"jmuserlogin_5", "layout"), container, false);
				break;
			default:
				view = inflater.inflate(AppConfig.resourceId(getActivity(),
						"jmuserlogin_4", "layout"), container, false);
		}
	...
	private void intView() {
		timer = new Timer();
		mIvregister = getView().findViewById(
