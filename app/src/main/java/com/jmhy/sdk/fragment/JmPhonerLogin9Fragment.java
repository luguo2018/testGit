...
public class JmPhonerLogin9Fragment extends JmBaseFragment implements
        OnClickListener {
    ...
    private void intView() {
        ...
        mTvagreement = (TextView) getView().findViewById(AppConfig.resourceId(getActivity(), "tvurl", "id"));
        mTvagreement.setOnClickListener(this);

        mTitleTv = (TextView) getView().findViewById(AppConfig.resourceId(getActivity(), "title_tv", "id"));
        ...
        mBtmobilelg = (TextView) getView().findViewById(AppConfig.resourceId(getActivity(), "mobilebt", "id"));
                ...
                AppConfig.appKey, new ApiRequestListener() {
                    ...
                    public void onSuccess(Object obj) {
                        ...
                        if (obj != null) {
                            ...
                            Log.i("测试日志1", "guest" + guest.toString());
