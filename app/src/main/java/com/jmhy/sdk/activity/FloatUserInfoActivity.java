    ...
    public void setViews(String url) {
        ...
        mWebview.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                Rect rect = new Rect();
                Log.d(TAG, "onGlobalLayout: 软键盘状态改变"+heightPixels);
...
//        if (getContentView().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
        if (true) {
        ...
        switch (AppConfig.skin) {
            case 9:
                ...
                if (notice){
                    ...
                    if (getContentView().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {//竖屏
                        FrameLayout.LayoutParams linearParams2 = (FrameLayout.LayoutParams) mWebview.getLayoutParams();
                        linearParams2.width = (int) (widthPixels * 0.8);
//                        linearParams2.height = (int) (heightPixels*0.6);
                        mWebview.setLayoutParams(linearParams2);
                    } else {
                        FrameLayout.LayoutParams linearParams2 = (FrameLayout.LayoutParams) mWebview.getLayoutParams();
